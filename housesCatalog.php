...
<a href="house_edit.php?id=<?=$house->house_id?>"><img class="edit_pic" src="images/ico/edit.ico" alt="edit"></a>
<a class="zero_btn" href="php_misc/house/delete_house.php?id=<?=$house->house_id?>">&times;</a>

</div> 
<?}?>
</div>
           
          <div class="news_picture"><img src="<?=$house->img_source?>"></div>                
